                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <main className="lg:w-full space-y-16 md:space-y-32">
                        ...
                        <section id="location" className="scroll-mt-32">
                            <h2 className="text-4xl font-bold mb-10 pb-6 border-b-2 border-black uppercase tracking-widest">Campus setting</h2>
                        ...
                        <section id="accessibility" className="scroll-mt-32">
                            <h2 className="text-4xl font-bold mb-10 pb-6 border-b-2 border-black uppercase tracking-widest">Global access</h2>
                            <div className="grid lg:grid-cols-2 gap-0 overflow-hidden group">
                                {/* Left: Square Image */}
                        ...
                        <section id="architecture" className="scroll-mt-32">
                            <h2 className="text-4xl font-bold mb-10 pb-6 border-b-2 border-black uppercase tracking-widest">Built environment</h2>
                        ...
                        <section id="facilities" className="scroll-mt-32">
                            <h2 className="text-2xl font-bold mb-10 uppercase tracking-widest text-black">
                                Learning Spaces
                            </h2>
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-0 mb-12">
                                {[
                                    ...
                                    <div key={item.title} className={`group cursor-pointer bg-white overflow-hidden p-8`}>
                        ...
                        <section id="library" className="scroll-mt-32">
                            <h2 className="text-4xl font-bold mb-10 pb-6 border-b-2 border-black uppercase tracking-widest">Knowledge center</h2>
                            <div className="grid lg:grid-cols-2 gap-0 overflow-hidden group">
                                {/* Left: Text Content */}
                                <div className="p-12 md:p-20 flex flex-col justify-center bg-white order-2 lg:order-1">
                                    ...
                                    <p className="text-lg text-black/60 italic leading-relaxed border-l-4 border-black pl-8 font-medium">
                        ...
                        <section id="housing" className="scroll-mt-32">
                            <h2 className="text-4xl font-bold mb-12 uppercase tracking-widest text-black">Living at Kestora</h2>
                            <div className="grid md:grid-cols-2 gap-4 lg:gap-8">
                                <div className="bg-neutral-100 p-12 group">
                        ...
                        <section id="organizations" className="scroll-mt-32">
                            <h2 className="text-4xl font-bold mb-10 pb-6 border-b-2 border-black uppercase tracking-widest">Associations</h2>
                            ...
                            <div>
                                <ul className="grid sm:grid-cols-2 gap-6">
                                    {["Academic networking", "Cultural events", "Sports teams", "Debate & hobbies"].map((item) => (
                                        <li key={item} className="p-6 border-b-2 border-black font-bold uppercase tracking-widest text-sm flex items-center gap-4">
                        ...
                        <section id="services" className="scroll-mt-32">
                            <h2 className="text-4xl font-bold mb-12 uppercase tracking-widest text-black">Integrated help</h2>
                            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-0">
                                {[
                                    ...
                                    <div key={item.name} className={`bg-white group hover:bg-black hover:text-white transition-all p-8 flex flex-col`}>
                        ...
                        <section id="future" className="scroll-mt-32">
                            <h2 className="text-2xl font-bold mb-8 uppercase tracking-widest text-black">
                                Evolution
                            </h2>
                            <p className="text-xl text-black leading-relaxed font-medium max-w-4xl">
                        ...
                        <section id="summary" className="scroll-mt-32 bg-black text-white p-12 md:p-20">
                            <h2 className="text-3xl font-black uppercase tracking-tighter mb-8">Integrated Experience</h2>
