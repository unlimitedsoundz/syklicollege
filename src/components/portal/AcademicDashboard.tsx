...
export default function AcademicDashboard({ student }: AcademicDashboardProps) {
    return (
        <div className="space-y-6">
            {/* Header */}
            <div>
                <h1 className="text-2xl font-bold uppercase tracking-tight text-neutral-900 leading-none mb-2">Student Portal</h1>
                <p className="text-black text-xs font-semibold uppercase tracking-widest">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-4">
                    ...
                    <div className="bg-white p-6 border border-neutral-200 rounded-sm">
                        ...
                        <div className="space-y-3 mb-4">
                            ...
                            <div className="pt-2">
                                ...
                                <p className="text-sm font-bold text-black">{student.program?.title}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-neutral-50 p-4 border border-neutral-200 rounded-sm">
                            ...
                            <p className="text-2xl font-bold text-black">0 / 180</p>
                        </div>
                        <div className="bg-neutral-50 p-4 border border-neutral-200 rounded-sm">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    {/* Status Banner */}
                    <div className="bg-neutral-50 border border-neutral-200 p-6 flex items-start gap-4 rounded-sm">
                        ...
                        <div>
                            <h3 className="font-bold text-black text-sm uppercase tracking-wide">Academic Status: Active</h3>
                            ...
                            <div className={`mt-4 flex gap-3 text-xs text-neutral-900 ${openSans.className}`}>
                    ...
                    <div>
                        <h3 className="font-bold text-sm uppercase tracking-widest pb-3 mb-6 flex items-center gap-2">
                            Academic Services
                        </h3>
                        <div className="grid md:grid-cols-2 gap-4">
                            {[
                                ...
                                <Link href={item.href} key={item.label} className={`border border-neutral-200 rounded-sm overflow-hidden hover:border-black transition-all group bg-white ${!item.active ? 'opacity-50 cursor-not-allowed' : ''}`}>
                                    ...
                                    <div className="p-4">
                                        <h4 className="font-bold text-xs uppercase tracking-wide mb-0.5">{item.label}</h4>
                                        <p className="text-[10px] text-black font-medium">{item.desc}</p>
                                    </div>
                                </Link>
                            ))}
                        </div>
                    ...
                    {/* Orientation/News */}
                    <div>
                        <h3 className="font-bold text-sm uppercase tracking-widest pb-3 mb-3">Urgent Notifications</h3>
                        <div className="bg-neutral-50 p-6 border-l-2 border-black">
                            <p className="text-sm font-bold mb-1">Orientation Week Starts</p>
                            <p className="text-xs text-black">Monday, 25th August • 09:00 AM • Main Auditorium</p>
                        </div>
                    </div>
                </div>
            </div>
