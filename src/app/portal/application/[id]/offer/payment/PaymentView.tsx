...
import { processTuitionPayment } from '@/app/portal/actions';
...
export default function TuitionPaymentPage({ admissionOffer, application }: {
    ...
    if (application.status === 'ENROLLED' || application.status === 'PAYMENT_SUBMITTED') {
        ...
        return (
            <div className="max-w-md mx-auto mt-12 bg-white border border-neutral-200 p-12 rounded-sm text-center shadow-sm animate-in fade-in zoom-in-95 duration-500">
                ...
                <button
                    ...
                    className="w-full bg-black text-white px-8 py-4 rounded-sm text-[10px] font-black uppercase tracking-widest hover:bg-neutral-800 transition-all shadow-lg shadow-black/5"
                >
                    Go to Dashboard
                </button>
            </div>
        ...
        <div className="max-w-6xl mx-auto py-6 md:py-12 md:px-4 font-rubik text-black">
            ...
            <div className="grid lg:grid-cols-12 gap-6 lg:gap-12 items-start">
                ...
                <div className="lg:col-span-4 space-y-6">
                    <div className="bg-white border md:border-neutral-100 p-6 md:p-8 -mx-4 md:mx-0">
