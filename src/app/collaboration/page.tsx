...
export const metadata = {
    ...
    description: 'Partner with Kestora College for research, innovation, and education. Join our network of industry leaders driving systemic change.',
};
    ...
    return (
        <div className="min-h-screen bg-white text-black font-sans">
            ...
            <SchemaLD data={{
                ...
                "@type": "WebPage",
                "name": "Collaboration & Partnerships at Kestora College",
                "url": "https://kestora.online/collaboration",
                "description": "Information on industry partnerships, collaborative research, and corporate training at Kestora College."
            }} />
                ...
                <section className="mb-32">
                    <div className="text-center mb-16 max-w-3xl mx-auto">
                        ...
                        <p className="text-lg text-neutral-600 leading-relaxed">
                            Kestora College offers a dynamic ecosystem where organizations can access top-tier talent, engage agile R&D capabilities, and upskill their workforce.
                        </p>
                    </div>
