...
import { ArrowRight, Phone, House as Home, TrendUp as TrendingUp, ShieldCheck, Globe, PencilSimple as Edit } from "@phosphor-icons/react/dist/ssr";
import { createClient } from '@/utils/supabase/server';
import { Faculty } from '@/types/database';

export const revalidate = 0;

export default async function BusinessSchoolPage() {
    const supabase = await createClient();

    // Check if user is admin
    const { data: { user } } = await supabase.auth.getUser();
    const isAdmin = !!user; // Simplified check for now (any logged in user can see edit links in this dev environment)

    // Business School ID: a54123ea-caae-40ec-b3b0-d2c1d91528ca
    const schoolId = 'a54123ea-caae-40ec-b3b0-d2c1d91528ca';
    ...
    // Color theme for links/hover
    const themeColor = 'group-hover:text-emerald-700';
        ...
        <div className="min-h-screen bg-white text-neutral-900 font-sans">
                ...
                <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-16 pt-32 pb-4 md:pt-48 lg:py-0 lg:h-[650px] relative mb-12">
                    ...
                    <div className="lg:w-1/2 space-y-8 relative z-10 flex flex-col justify-center h-full pt-0 lg:pt-0">
                        ...
                        <p className="text-xl text-white/90 max-w-xl leading-relaxed">
                            Developing leaders for the green economy through circular business models, social responsibility, and sustainable value creation.
                        </p>
                    ...
                    <div className="lg:w-1/2 h-full w-full relative mt-8 lg:mt-0 lg:translate-y-16 z-20">
                        <div className="relative w-full h-[450px] lg:h-[100%] bg-neutral-800 shadow-2xl overflow-hidden">
                            <Image
                                src="/images/school-business.jpg"
            ...
            <section id="departments" className="py-8 md:py-24 bg-white">
                <div className="container mx-auto px-4">
                    <div className="mb-16">
                        ...
                        <p className="text-neutral-600 text-lg max-w-2xl">Organised into core departments driving sustainable business innovation and ethical leadership.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {departments?.map((dept) => {
                            ...
                            return (
                                <Link
                                    key={dept.id}
                                    href={`/schools/business/${dept.slug}`}
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="text-neutral-600 mb-6 leading-relaxed line-clamp-3 text-sm">
                                            {dept.description || 'Leading innovation and research in this field to drive sustainable change and societal impact.'}
                                        </p>
                                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-8">
                            ...
                            <p className="text-neutral-400 text-lg leading-relaxed">
                                Our research addresses the critical challenges of the 21st century, developing actionable knowledge for a sustainable and equitable global economy.
                            </p>
                        ...
                        <div className="bg-neutral-900 aspect-video relative group overflow-hidden border border-white/10">
                            <Image src="/images/pexels-fauxels-3184291--1-.jpg" alt="Business Research" fill className="object-cover opacity-80 group-hover:scale-105 transition-transform duration-700" sizes="(max-width: 1024px) 100vw, 50vw" />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end p-8">
                                <div className="w-full">
                                    <p className="text-lg text-white/90 font-medium mb-4">
                                        "Partnering with over 500 organizations to drive systemic change."
                                    </p>
                                    <Link href="/research" className="inline-flex items-center gap-2 text-white font-bold hover:underline">
                                        View Research Projects <ArrowRight size={16} weight="bold" />
                                    </Link>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-8 md:py-24 bg-neutral-50">
                <div className="container mx-auto px-4">
                    <div className="mb-16">
                        ...
                        <p className="text-black max-w-2xl">The experts and thought leaders shaping the future of sustainable business.</p>
                    </div>
                        ...
                        <div className="bg-black text-white p-12">
                            ...
                            <div className="space-y-8">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold">Prof. Björn Keller</p>
                                    <p className="text-neutral-400 text-sm">Dean, School of Business</p>
                                </div>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-sm">
                                    <div>
                                        <p className="text-neutral-500 mb-2">Administrative</p>
                                        <ul className="space-y-1 text-neutral-300">
                                            <li>Prof. Pasi Mattila - Finance</li>
                                            <li>Prof. Sami Kinnunen - HR</li>
                                            <li>Prof. Tuula Turunen - Research</li>
                                        </ul>
                                    </div>
                                    <div>
                                        <p className="text-neutral-500 mb-2">Heads of Dept.</p>
                                        <ul className="space-y-1 text-neutral-300">
                                            <li>Mgmt: Dr. Sarah Dubois</li>
                                            <li>Finance: Dr. Adrian Nielsen</li>
                                            <li>Marketing: Dr. Sari Schröder</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="grid lg:grid-cols-2 gap-16">
                        ...
                        <div className="bg-[#f3e600] p-16 text-black flex flex-col justify-center">
                            <h2 className="text-4xl font-black mb-8 uppercase tracking-tighter">Why School of Business?</h2>
                            <div className="space-y-6">
                                {[
                                    "Pioneering circular economy education",
                                    "Deep integration with green industry leaders",
                                    "Focus on ethical leadership and governance",
                                    "Real-world impact projects and case studies",
                                    "Global network of sustainable innovators"
                                ].map((point) => (
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="space-y-4">
                                    <div className="flex gap-4 items-center">
                                        <span className="font-medium">General: business@syklicollege.fi</span>
                                    </div>
                                    <div className="flex gap-4 items-center">
                                        <span className="font-medium">Admissions: business.admissions@syklicollege.fi</span>
                                    </div>
                                    <div className="flex gap-4 items-center">
                                        <span className="font-medium">Partnerships: business.partners@syklicollege.fi</span>
                                    </div>
                                </div>
            ...
            <section className="bg-black text-white py-12">
                <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
                    <p className="text-2xl font-bold underline decoration-white/30">Lead the change in sustainable business.</p>
